~(function(win){
	...
	ImgFileupload.prototype.init =function() {
		...
		this.dom.innerHTML ='<div style="display: flex;margin-top: -18px"><input type="checkbox" name="selectFlag"></div>'+
							'    <img src="img/login.gif" alt="" data-src="'+this.imgSrc +'" class="imsg">'+
							'    <i class="delImg">'+
							'    </i>'+
							'<p style="margin-top: 106px;text-align: center;"><input type="button" value="-" style="width: 20px" class="subtraction" onclick="subOne(this)"><input type="text" value="12" style="width: 40px;text-align: center" class="showNumber" onBlur="showNumber(this)"><input type="button" value="+" style="width: 20px" class="addition" onclick="addOne(this)"></p>';
